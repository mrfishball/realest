...
class BuyerSign extends Component {
  handleNextClick = () => {
      this.props.nextStep()
  }
  ...
  render() {
    return(
      <div>
        <h2 className="section">Buyer Signature</h2>
          <form class="form-horizontal">
              <fieldset>
                  ...
                  <buttom className="btn -primary pull-right" onClick={this.handleNextClick}>Submit</buttom>
