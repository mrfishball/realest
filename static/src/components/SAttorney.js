...
class SAttorney extends Component {
  handleNextClick = () => {
      this.props.nextStep()
  }
  ...
  render() {
    return(
      <div>
        <h2 className="section">Seller Attorney</h2>
              ...
              <fieldset>
                  ...
                  <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="postal-code" name="postal-code" type="text" placeholder="Phone or Fax"
                            class="input-xlarge"/>
                            <p class="help-block"></p>
                        </div>
                      </div>
                      <div class="control-group">
                          ...
                          <div class="controls">
                              <input id="postal-code" name="postal-code" type="text" placeholder="Email"
                              class="input-xlarge"/>
                              <p class="help-block"></p>
                          </div>
                        </div>
